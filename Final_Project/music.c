...
//	oi_loadSong(MARIO_UNDERWATER, mario2NumNotes, mario2Notes, mario2Duration);
	unsigned char harvesterNumNotes = 14;
	unsigned char harvesterNotes[14]    = {62, 59, 65, 66, 66, 66, 66, 66, 66, 62, 62, 62, 62, 57};
	unsigned char harvesterDuration[14] = {4, 4, 8, 4, 4, 8, 4, 4, 8, 4, 4, 16, 8, 8};
	oi_loadSong(INTERNATIONAL_HARVESTER, harvesterNumNotes, harvesterNotes, harvesterDuration);
}

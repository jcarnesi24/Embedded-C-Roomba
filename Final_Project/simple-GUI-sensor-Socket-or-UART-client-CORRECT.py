...
def main():
        ...
        # move_forward_Button = tk.Button(text="Press to move forward", command = send_move)
        # move_forward_Button.pack()

        # move_left_Button = tk.Button(text="Press to move left", command = send_left)
        # move_left_Button.pack()

        # move_right_Button = tk.Button(text="Press to move right", command = send_right)
        # move_right_Button.pack()

        # move_back_Button = tk.Button(text="Press to move back", command = send_back)
